    ...
    static class PieceSquareTables
    {
        public static int Read(int piece, int square)
        {
            ...
            return Piece.PieceType(piece) switch {
                Piece.Pawn => Read(pawns, square, isWhite),
                Piece.Knight => Read(knights, square, isWhite),
                Piece.Bishop => Read(bishops, square, isWhite),
                Piece.Rook => Read(rooks, square, isWhite),
                Piece.Queen => Read(queens, square, isWhite),
                Piece.King => Read(kingMiddle, square, isWhite),
                _ => 0
            };
        }
